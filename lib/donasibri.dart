...
class donasiBRI extends StatefulWidget {
  const donasiBRI({Key? key}) : super(key: key);



  @override
  _donasiBRIState createState() => _donasiBRIState();
}

class _donasiBRIState extends State<donasiBRI> {
