...
class transferBNI extends StatefulWidget {
  const transferBNI({Key? key}) : super(key: key);



  @override
  _transferBNIState createState() => _transferBNIState();
}

class _transferBNIState extends State<transferBNI> {
